...
public class StepDefinations {
	...
	public void i_should_navigate_to_movement_page() {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
	...
	public void i_should_navigate_to_watchlist_page() {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
	...
	public void i_should_navigate_to_report_page() {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
	...
	public void i_verify_the_number_of_tanks_in_movement_page() {
		Assert.assertEquals(overviewpage.VerifyNumberofMovementTanksinAllTanksTab(), movementpage.VerifyNumberofTanksinAllTanksTab());
